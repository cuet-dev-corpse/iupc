        ...
        <section id="banner" className='container2 md:mb-4 mb-0 relative'>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="flex flex-col flex-[2.2] md:order-1 ordesr-2">
                    ...
                    <div style={{ fontFamily: '"__Chakra_Petch_fc4616" monospace' }} className="lg:text-5xl md:text-4xl sm:text-3xl text-[25px] font-bold uppercase flex items-start flex-col gap-0 sm:gap-4 text-[#e5edff]">
